  ...
  return (
    <div className="min-h-screen bg-pista-200 text-slate-900 flex flex-col justify-between p-6 md:p-12 font-sans selection:bg-pista-300">
      <div className="max-w-5xl mx-auto w-full space-y-8">
        ...
        <header className="bg-bottle-900 border border-bottle-800 rounded-3xl p-4 md:p-6 flex items-center justify-between shadow-md text-white">
          <div className="flex items-center space-x-3">
            <div className="w-12 h-12 rounded-2xl bg-bottle-800 border border-bottle-700 flex items-center justify-center text-white font-bold text-2xl shadow-inner">
              🏛️
            </div>
            <div>
        ...
        <div className="bg-pista-100 rounded-3xl p-6 border border-pista-400 shadow-xl">
          ...
          <div className="p-12 border-2 border-dashed border-pista-400 rounded-2xl text-center space-y-3 bg-pista-200/50">
